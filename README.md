...
- Projected revenue shortfall chart for FY2028 through FY2032
...
- Department detail cards with FY2022-FY2025 historical funding and FY2027 budget views
- Department funding toggle for gross expense and ad valorem support
...
├── data/
│   ├── budgetData.js
│   └── historicalDepartmentFunding.js
└── README.md
```
...
Historical department funding data is stored in `data/historicalDepartmentFunding.js`. It includes:

- FY2022 through FY2025 gross expense, department revenue, net expense, and ad valorem support by department
- Historical-only departments shown in Department Detail but excluded from scenario reduction controls
- Reconciled annual ad valorem support totals:
  - FY2022: $89,972,682
  - FY2023: $110,875,024
  - FY2024: $131,679,989
  - FY2025: $149,437,335
- Methodology notes for weighted allocation, priority allocation, and annual reconciliation
